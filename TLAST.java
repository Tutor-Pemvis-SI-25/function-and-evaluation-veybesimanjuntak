...
public class TLAST {
    ...
    public static void descending(String[] deskripsitugas, String[] kodematkul, String[] dosen, String[] matkul, String[] deadline, String[] nimnama, double[] tingkatkesulitan, int[] harihinggadeadline, String[] status, double[] prioritas, String[] teks, int i, int n) {
        int h;
